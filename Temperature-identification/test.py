...
# 分别记录jpg格式红外图和bmp位图中方框温度所在显示位置,包括整数位和小数位
cropjpg=[[581, 196, 600, 230],[525, 196, 577, 230]]
cropbmp=[[578, 227, 607, 257],[503, 227, 570, 257]]
...
rootdir = 'C:\\Users\\zhy\\Desktop\\temperature_test'
all=os.walk(rootdir)
...
for filename in testlist:
    if filename.endswith('JPG'):
        cropparameter=cropjpg
    else:
        cropparameter=cropbmp
    print (filename+'\t')
    ...
    if text_c1=="" or text_c2=="":
        ...
        text.append(text_c2+"."+text_c1+"°C")
        print(text_c2+"."+text_c1+"°C\n")
